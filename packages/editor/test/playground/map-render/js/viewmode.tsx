...
const visible = JSON.parse('{"122":"visible_not-visible","139":"visible_not-visible","140":"visible_not-visible","141":"visible_not-visible","142":"visible_not-visible","158":"visible_visible"}');
const isFriend = true;
