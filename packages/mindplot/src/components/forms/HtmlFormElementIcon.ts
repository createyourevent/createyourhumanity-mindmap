import HtmlFormImage from '../../../assets/icons/html/form.png';
...
class HtmlFormElementIcon extends Icon {
    ...
    constructor(topic: Topic, htmlElementModel: HtmlFormModel, readOnly: boolean) {
        ...
        super(HtmlFormElementIcon.IMAGE_URL);
    ...
    static IMAGE_URL = HtmlFormImage;
  }
  
  export default HtmlFormElementIcon;