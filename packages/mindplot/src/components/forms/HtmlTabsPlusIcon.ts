import TabsPlus from '../../../assets/icons/html/tabs-plus.png';
...
class HtmlTabsPlusIcon extends Icon {
    ...
    constructor(topic: Topic, htmlElementModel: HtmlFormModel, readOnly: boolean) {
        ...
        super(HtmlTabsPlusIcon.IMAGE_URL);
    ...
    static IMAGE_URL = TabsPlus;
  }
  
  export default HtmlTabsPlusIcon;