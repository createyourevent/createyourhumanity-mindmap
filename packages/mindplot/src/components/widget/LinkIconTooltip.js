...
class LinkIconTooltip extends FloatingTip {
  constructor(linkIcon) {
    ...
    super(nativeElement, {
      ...
      title: $msg('LINK'),
      trigger: 'manual',
      template: '<div id="linkPopover" class="popover" onmouseover="jQuery(this).mouseleave(function() {jQuery(this).fadeOut(200); });" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>',
      destroyOnExit: true,
    });
  }
