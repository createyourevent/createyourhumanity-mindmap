...
abstract class ActionDispatcher extends Events {
  ...
  abstract addControlToTopic(topicId: number, type: string, attributes: object): void;

  abstract changeControlToTopic(topicId: number, featureId: string, attributes: object): void;
